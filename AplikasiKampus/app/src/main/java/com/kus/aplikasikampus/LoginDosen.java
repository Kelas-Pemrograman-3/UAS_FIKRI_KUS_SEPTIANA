...
public class LoginDosen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_logindosen);
        ...
        dSetting = LoginDosen.this.getSharedPreferences("Settings", Context.MODE_PRIVATE);

        btnback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(LoginDosen.this, WelcomeActivity.class);
                startActivity(i);
                finish();
            }
        });

        txtnidn = findViewById(R.id.txtlognidn);
        txtpass = findViewById(R.id.txtlogpassdosen);

        logindos = findViewById(R.id.btnloglogindosen);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (status == true) {
                                ...
                                Intent a = new Intent(LoginDosen.this, MainMenuDosen.class);
                                startActivity(a);
                                finish();
