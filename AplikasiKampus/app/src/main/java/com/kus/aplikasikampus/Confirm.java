...
public class Confirm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSetting = Confirm.this.getSharedPreferences("Settings", Context.MODE_PRIVATE);
        ...
        btnback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Confirm.this, EditProfile.class);
                startActivity(i);
                finish();
            }
        });
        ...
        npm = (EditText) findViewById(R.id.txtconnpm);
        password = (EditText) findViewById(R.id.txtconpassword);


        btnlogin = (Button) findViewById(R.id.btnconlogin);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (status == true) {
                                ...
                                Intent a = new Intent(Confirm.this, Profile.class);
                                startActivity(a);
                                finish();
